...
def get_config(
    ...
    hidden_state_kv_over_ksum_reference: float | None = None,
        ...
        backbone=LinearAttentionBackboneConfig(
            ...
            layer_kwargs={
                ...
                **layer_kwargs,
                ...
                "hidden_state_frobenius_norm_target": hidden_state_frobenius_norm_target,
                "hidden_state_frobenius_norm_length_normalization": hidden_state_frobenius_norm_length_normalization,
                "hidden_state_frobenius_norm_constant_after_length": hidden_state_frobenius_norm_constant_after_length,
                "hidden_state_frobenius_norm_eval_only": hidden_state_frobenius_norm_eval_only,
                "hidden_state_kv_over_ksum_reference": hidden_state_kv_over_ksum_reference,
                "hidden_state_kv_over_ksum_reference_apply": hidden_state_kv_over_ksum_reference_apply,
                "hidden_state_kv_over_ksum_reference_eval_only": hidden_state_kv_over_ksum_reference_eval_only,
                "attention_output_norm_max": attention_output_norm_max,
                "attention_output_norm_length_normalization": attention_output_norm_length_normalization,
                #"feature_dim": 64,
            },
        ),
