...
def get_config(config_index: int = 0) -> MainConfig:
    ...
    prior = TabPFNPriorConfig(
        ...
        nan_handling=True,
        different_generating_model_per_dataset=False,
    )
    ...
    wandb_config = WandbConfig(
        ...
        name=f"transformer_1_gpu_v4_performance_1_sample_new_prior_model_within_batch_{config_index}",
        mode="online",
    ...
    return MainConfig(
        ...
        skip_grad_norm_spike_factor=1000.0,
        scheduler="cosine_decay",
        progress_bar=True,
        wandb=wandb_config,
        num_workers=8,
        aggregate_k_gradients=2*8,
    )
